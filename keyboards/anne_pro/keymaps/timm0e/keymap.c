...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
            ...
            KC_LCTL, KC_LWIN, KC_LALT,                   KC_SPACE,                                    KC_RALT, KC_MENU, KC_RCTL, MO(1)
            ),
    [1] = LAYOUT(
            ...
            _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, TG(3),   XXXXXXX, XXXXXXX, XXXXXXX, KC_INS,  KC_UP,                     MO(2),
            _______, _______, _______,                   XXXXXXX,                                     KC_LEFT, KC_DOWN, KC_RGHT, _______
            ),
    [2] = LAYOUT(
